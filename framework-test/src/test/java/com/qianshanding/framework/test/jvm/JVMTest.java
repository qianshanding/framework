package com.qianshanding.framework.test.jvm;
...
public class JVMTest {
    ...
    private static void hotSpotDiagnosticMXBean() throws IOException {
        MBeanServer server = ManagementFactory.getPlatformMBeanServer();
        HotSpotDiagnosticMXBean hotspotDiagnosticMXBean = ManagementFactory.newPlatformMXBeanProxy(server,
                "com.sun.management:type=HotSpotDiagnostic", HotSpotDiagnosticMXBean.class);
        System.out.println(hotspotDiagnosticMXBean.getObjectName());
        System.out.println(hotspotDiagnosticMXBean.getDiagnosticOptions());
    }
}
